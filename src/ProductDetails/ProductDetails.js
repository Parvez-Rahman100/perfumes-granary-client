...
const ProductDetails = () => {
  ...
  // console.log(perfume);
  useEffect(() => {
    const url = `https://perfumes-granary-server.vercel.app/productDetails/${perfumeId}`;
    fetch(url)
      .then((res) => res.json())
  ...
  const handleUpdateProducts = (event) => {
    ...
    fetch(
      ` https://perfumes-granary-server.vercel.app/productDetails/${perfumeId}`,
      {
        method: "PUT",
        headers: {
  ...
  return (
    <div className="w-50 my-3 mx-auto">
      <form className="d-flex flex-column" onSubmit={handleUpdateProducts}>
        ...
        <input
          className="btn w-25 mx-auto btn-primary mt-3"
          type="submit"
          value="Add Quantity"
        />
      </form>
      ...
      <div className="d-flex justify-content-center align-items-center my-5">
        <div className="card" style={{ width: "18rem" }}>
          ...
          <div className="card-body">
            ...
            <button
              onClick={handleDeleveredProduct}
